...
icons = {
    "drug": "/home/shashemi/Desktop/0-OneDrive/Output/Vis/drug.png",
    "drug_and_disease_target": "/home/shashemi/Desktop/0-OneDrive/Output/Vis/drug_and_disease_target.png",
    "drug_target": "/home/shashemi/Desktop/0-OneDrive/Output/Vis/drug_target.png",
    "indirect_drug_target": "/home/shashemi/Desktop/0-OneDrive/Output/Vis/indirect_drug_target.png",
    "non_drug_target": "/home/shashemi/Desktop/0-OneDrive/Output/Vis/non_drug_target.png",
}
...
for i in range(len(drug_lst)):
    if sum(mat[:,i]) > 0:
        ...
        # G.add_node(label, image=images["drug"])
...
# pos = nx.spring_layout(G, k=0.4, seed=1734289230)
...
plt.show()
fig.savefig('/home/shashemi/Desktop/0-OneDrive/Output/Vis/drug_network.png', dpi=1000)