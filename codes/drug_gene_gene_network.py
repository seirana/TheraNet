...
The function visualizes the drug_gene_gene interaction networks based on drug_gene_matrix.

INPUT:
    ~/output/nodes_drug_list
    ~/output/nodes_gene_list_type
    ~/output/gene_drug_gene_matrix
    ~/icons/drug.png
    ~/icons/drug_and_disease_target.png
    ~/icons/drug_target.png
    ~/icons/indirect_drug_target.png
    ~/icons/non_drug_target.png
    
OUTPUT:
    ~/output/drug_network.png
"""
...
file = '~/output/nodes_drug_list'
drug_lst = rw.read_csv(file)

file = '~/output/nodes_gene_list_type'
gene_lst_tp = rw.read_csv(file)

file = '~/output/gene_drug_gene_matrix'
