...
The function identifies connections between genes, and between drugs and genes.

INPUT:
    ~/datat/disease_target_genes
    ~/data/gene
    ~/output/suggested_drugs
    ~/data/gene_gene_PPI900
...
def drug_gene_matrix():
    ...
    #direct targe genes
    file = '~/data/disease_target_geness'
