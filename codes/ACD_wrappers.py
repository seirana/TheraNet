...
def calculate_proximity_multiple(network, drugs_lst_file, drugs_file, disease_file, check_file, folder, sampling, part, parts, title):
    ...
    file =  folder + str(sampling) + '_' + str(part) + title
